namespace Dentora.Forms
{
    partial class ManageInventory
    {
        ...
        private void InitializeComponent()
        {
            ...
            lblTitle.BackColor = Color.Transparent; lblTitle.Font = new Font("Segoe UI", 16F, FontStyle.Bold); lblTitle.ForeColor = Color.FromArgb(0, 150, 136); lblTitle.Location = new Point(120, 10); lblTitle.Name = "lblTitle"; lblTitle.Size = new Size(400, 40); lblTitle.Text = "Manage Inventory";
            ...
            AutoScaleDimensions = new SizeF(8F, 20F); AutoScaleMode = AutoScaleMode.Font; BackgroundImage = Properties.Resources.app_backround; BackgroundImageLayout = ImageLayout.Stretch; ClientSize = new Size(914, 560); Controls.Add(logoBox); Controls.Add(lblTitle); Controls.Add(dgvInventory); Controls.Add(btnAdd); Controls.Add(btnDelete); Controls.Add(btnBack); DoubleBuffered = true; Name = "ManageInventory"; StartPosition = FormStartPosition.CenterScreen; Text = "Dentora - Manage Inventory"; Load += ManageInventory_Load;
