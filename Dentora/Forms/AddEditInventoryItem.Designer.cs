namespace Dentora.Forms
{
    partial class AddEditInventoryItem
    {
        ...
        private void InitializeComponent()
        {
            ...
            lblSupplier = new Label(); txtSupplier = new TextBox();
            ...
            // lblSupplier
            lblSupplier.AutoSize = true; lblSupplier.Font = new Font("Segoe UI", 11F, FontStyle.Bold); lblSupplier.Location = new Point(30, 275); lblSupplier.Text = "Supplier";
            // txtSupplier
            txtSupplier.Location = new Point(30, 300); txtSupplier.Size = new Size(320, 27); txtSupplier.Font = new Font("Segoe UI", 11F);
            // lblImage
            lblImage.AutoSize = true; lblImage.Font = new Font("Segoe UI", 11F, FontStyle.Bold); lblImage.Location = new Point(30, 340); lblImage.Text = "Image";
            // picImage
            picImage.Location = new Point(30, 365); picImage.Size = new Size(120, 90); picImage.SizeMode = PictureBoxSizeMode.Zoom; picImage.BorderStyle = BorderStyle.FixedSingle; picImage.BackColor = Color.FromArgb(45, 45, 45);
            // btnBrowseImage
            btnBrowseImage.BackColor = Color.FromArgb(0, 150, 136); btnBrowseImage.FlatStyle = FlatStyle.Flat; btnBrowseImage.FlatAppearance.BorderSize = 0; btnBrowseImage.Font = new Font("Segoe UI", 9F, FontStyle.Bold); btnBrowseImage.ForeColor = Color.White; btnBrowseImage.Location = new Point(160, 365); btnBrowseImage.Size = new Size(100, 35); btnBrowseImage.Text = "\U0001F4C2 Browse"; btnBrowseImage.Click += btnBrowseImage_Click;
            // btnClearImage
            btnClearImage.BackColor = Color.FromArgb(55, 55, 55); btnClearImage.FlatStyle = FlatStyle.Flat; btnClearImage.FlatAppearance.BorderSize = 0; btnClearImage.Font = new Font("Segoe UI", 9F, FontStyle.Bold); btnClearImage.ForeColor = Color.White; btnClearImage.Location = new Point(270, 365); btnClearImage.Size = new Size(80, 35); btnClearImage.Text = "Clear"; btnClearImage.Click += btnClearImage_Click;
            btnSave.BackColor = Color.FromArgb(0, 150, 136); btnSave.FlatStyle = FlatStyle.Flat; btnSave.FlatAppearance.BorderSize = 0; btnSave.Font = new Font("Segoe UI", 11F, FontStyle.Bold); btnSave.ForeColor = Color.White; btnSave.Location = new Point(30, 475); btnSave.Size = new Size(140, 45); btnSave.Text = "\U0001F4BE Save"; btnSave.Click += btnSave_Click;
            btnCancel.BackColor = Color.FromArgb(55, 55, 55); btnCancel.FlatStyle = FlatStyle.Flat; btnCancel.FlatAppearance.BorderSize = 0; btnCancel.Font = new Font("Segoe UI", 11F, FontStyle.Bold); btnCancel.ForeColor = Color.White; btnCancel.Location = new Point(200, 475); btnCancel.Size = new Size(140, 45); btnCancel.Text = "Cancel"; btnCancel.Click += btnCancel_Click;
            AutoScaleDimensions = new SizeF(8F, 20F); AutoScaleMode = AutoScaleMode.Font; ClientSize = new Size(400, 540); Controls.Add(lblHeader); Controls.Add(lblName); Controls.Add(txtName); Controls.Add(lblDescription); Controls.Add(txtDescription); Controls.Add(lblQuantity); Controls.Add(nudQuantity); Controls.Add(lblPrice); Controls.Add(nudPrice); Controls.Add(lblSupplier); Controls.Add(txtSupplier); Controls.Add(lblImage); Controls.Add(picImage); Controls.Add(btnBrowseImage); Controls.Add(btnClearImage); Controls.Add(btnSave); Controls.Add(btnCancel); FormBorderStyle = FormBorderStyle.FixedDialog; Icon = Icon.FromHandle(Properties.Resources.dentora_logo1.GetHicon()); MaximizeBox = false; Name = "AddEditInventoryItem"; StartPosition = FormStartPosition.CenterParent; Text = "Dentora - Inventory Item"; Load += AddEditInventoryItem_Load;
        ...
        private Label lblSupplier; private TextBox txtSupplier;
